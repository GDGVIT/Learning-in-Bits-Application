...
import 'package:learning_in_bits/screens/main_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    pages = [new MainPage(token: widget.token,), new ViewProfile(token: widget.token,), new EditProfile(token: widget.token,)];
